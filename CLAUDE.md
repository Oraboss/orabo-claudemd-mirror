...
- **Tables:** `user_profiles`, `purchases`, `one_off_purchases`, `ai_cache`, `processed_webhook_events`, `analytics_events`, `budget_tracker`, `timeline_milestones`
...
- `timeline_milestones`: Empty user-id-keyed OPS table. Defensively swept by F6.10.3 delete cron and enumerated as [] by F6.10.4 export. Origin unverified; if a future feature claims this table name, audit before reuse.
