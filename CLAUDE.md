...
- Env: `BREVO_API_KEY`, `BREVO_LIST_ID`, `BREVO_SENDER_EMAIL`, `BREVO_SENDER_NAME`, `ADMIN_NOTIFY_EMAIL`, `DIGEST_TRIGGER_SECRET`, `BREVO_WEBHOOK_SECRET` (URL query-secret gating `POST /api/brevo-webhook`).
